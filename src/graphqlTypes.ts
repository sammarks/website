...
export enum FileFieldsEnum {
  ...
  ChildMarkdownRemarkFieldsSocialImagePath = 'childMarkdownRemark___fields___socialImagePath',
...
export type MarkdownRemarkFields = {
  ...
  socialImagePath: Maybe<Scalars['String']>
}
...
export enum MarkdownRemarkFieldsEnum {
  ...
  FieldsSocialImagePath = 'fields___socialImagePath',
  Html = 'html',
  HtmlAst = 'htmlAst',
...
export type MarkdownRemarkFieldsFilterInput = {
  ...
  socialImagePath: Maybe<StringQueryOperatorInput>
}
...
export type SeoQuery = {
  site: Maybe<{
    siteMetadata: Maybe<
      Pick<SiteSiteMetadata, 'title' | 'description' | 'canonicalUrl' | 'image' | 'ogImage'> & {
...
export type PageMetaTemplateQueryVariables = {
  slug: Scalars['String']
}

export type PageMetaTemplateQuery = {
  markdownRemark: Maybe<Pick<MarkdownRemark, 'timeToRead'> & { frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title'>> }>
}
...
export type PageTemplateQuery = {
  markdownRemark: Maybe<
    Pick<MarkdownRemark, 'htmlAst'> & {
      ...
      fields: Maybe<Pick<MarkdownRemarkFields, 'slug' | 'socialImagePath'>>
      frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'summary' | 'date'>>
    }
  >
}
